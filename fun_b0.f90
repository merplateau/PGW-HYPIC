    ...
    real*8   ::rl_b0,zl_b0,pre,db,h_b0,dr_b0,dz_b0
    ...
    rl_b0=0.5;
    zs_b0=-0.5
    zl_b0=1.+.5; !-calulation region
    z_magcenter=zs_b0+(zl_b0-zs_b0)*0.5
    ...
    !mz=nint(nz*real((zl_b0-zs_b0)/zl));
    dz_b0=(zl_b0-zs_b0)/(real(mz)-1.);
    h_b0=dz_b0
    dr_b0=dz_b0
    mr=nint((rl_b0-rs_b0)/dr_b0+1);
    !mr=nint(nr*real((rl_b0-rs_b0)/rl));
    ...
    i_coil=1; I_th(i_coil)=1.*0.6*1e5;!A
    i_coil=2; I_th(i_coil)=3.5*0.05*1e5;!A
    i_coil=3; I_th(i_coil)=I_th(2)! 1.*0.15*1e5;!A
    !i_coil=4; I_th(i_coil)=I_th(1)! 1.55*0.2*1e5;!A
    !i_coil=5; I_th(i_coil)=1.5*.1*1e5;!A


    !(1:4)=(r1,r2,z1,z2)
    ! coil 0
    i_coil=0; !not use here
    posi_coils(1:4,i_coil)=rz_dipole(1:4);

    ! coil 1
    i_coil=1;
    posi_coils(1,i_coil)=10d-2;
    posi_coils(2,i_coil)=12d-2;
    posi_coils(3,i_coil)=0.2;
    posi_coils(4,i_coil)=0.8;

    ! coil 2
    i_coil=2;
    posi_coils(1,i_coil)=7d-2;
    posi_coils(2,i_coil)=10d-2;
    posi_coils(3,i_coil)=0.15;
    posi_coils(4,i_coil)=0.2;

    ! coil 3
    i_coil=3;
    posi_coils(1,i_coil)=7d-2;
    posi_coils(2,i_coil)=10d-2;
    posi_coils(3,i_coil)=0.8;
    posi_coils(4,i_coil)=0.85;
    ...
    !i_fermag=2;
    !posi_fermag(1,i_fermag)=0.303;
    !posi_fermag(2,i_fermag)=0.516;
    !posi_fermag(3,i_fermag)=z_magcenter+.761+dz_b0*3;!
    !posi_fermag(4,i_fermag)=z_magcenter+.776+dz_b0*3;!+0.2
    !
    !i_fermag=3;
    !posi_fermag(1,i_fermag)=0.476+dr_b0*3;!
    !posi_fermag(2,i_fermag)=0.516+dr_b0*3;!+0.2
    !posi_fermag(3,i_fermag)=z_magcenter-.761;
    !posi_fermag(4,i_fermag)=z_magcenter-.639;
    !
    !i_fermag=4;
    !posi_fermag(1,i_fermag)=0.476+dr_b0*3;!
    !posi_fermag(2,i_fermag)=0.516+dr_b0*3;!+0.2
    !posi_fermag(3,i_fermag)=z_magcenter+.639;
    !posi_fermag(4,i_fermag)=z_magcenter+.761;
    !
    !i_fermag=5;
    !posi_fermag(1,i_fermag)=0.582+dr_b0*3;!
    !posi_fermag(2,i_fermag)=0.616+dr_b0*3;!+0.2
    !posi_fermag(3,i_fermag)=z_magcenter-.374;
    !posi_fermag(4,i_fermag)=z_magcenter-.176;
    !
    !i_fermag=6;
    !posi_fermag(1,i_fermag)=0.582+dr_b0*3;!
    !posi_fermag(2,i_fermag)=0.616+dr_b0*3;!+0.2
    !posi_fermag(3,i_fermag)=z_magcenter+.176;
    !posi_fermag(4,i_fermag)=z_magcenter+.374;
    ...
    !j_th=I_th/((posi_coils(2,:)-posi_coils(1,:))*(posi_coils(4,:)-posi_coils(3,:)));
